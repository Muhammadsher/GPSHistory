...
(function(factory) {
    ...
    L.Playback.PlayControl = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            this._speed1x = document.getElementById('1x');
            this._speed2x = document.getElementById('2x');
            this._speed3x = document.getElementById('3x');


            var stop = L.DomEvent.stopPropagation;

            L.DomEvent
                .on(this._speed1x, 'click', changeSpeed1x)
                .on(this._speed2x, 'click', changeSpeed2x)
                .on(this._speed3x, 'click', changeSpeed3x)
            ...
            function play() {
                if (playback.isPlaying()) {
                    playback.stop();
                    self._button.innerHTML = '<i class="flaticon flaticon-play"></i>';
                } else {
                    playback.start();
    ...
    L.Playback = L.Playback.Clock.extend({
        ...
        setTickLng: function(tickLen) {
            this.setTickLen(tickLen);
        },
