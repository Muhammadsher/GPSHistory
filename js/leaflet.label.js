...
L.Label = (L.Layer ? L.Layer : L.Class).extend({
	...
	setStyle: function (style) {
		...
		if (style.backgroundColor != undefined){
			this._container.style.backgroundColor = style.backgroundColor;
		}
		
		if (style.color != undefined){
			this._container.style.color = style.color;
		}
	...
	_initLayout: function () {
		this._container = L.DomUtil.create('div', 'leaflet-label leaflet-zoom-animated ' + this.options.className + ' ');
...
L.BaseMarkerMethods = {
	...
	getLabel: function (NewIfUndefined) {
		if (this.label == undefined && NewIfUndefined === true)
			this.bindLabel("");
